...
# Variables
SERVER_PATH="/opt/adventurelog"
BACKUP_PATH="/mnt/philips/adventurelog"
CONTAINER_NAME1="AdventureLog-DB"
CONTAINER_NAME2="AdventureLog-FRONTEND"
CONTAINER_NAME3="AdventureLog-SERVER"
MAX_BACKUPS=3
...
docker stop $CONTAINER_NAME3
sleep 10

echo "Le conteneur '$CONTAINER_NAME1' a été arrêté avec succès."
echo "Le conteneur '$CONTAINER_NAME2' a été arrêté avec succès."
